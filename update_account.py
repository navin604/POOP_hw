...
class UpdateAccount(tk.Frame):
    ...
    def __init__(self, parent, close_callback):
        ...
        ttk.Label(self, text="New Branch:").grid(row=2, column=1)
        self._branch = ttk.Entry(self)
        self._branch.grid(row=2, column=2)
    ...
    def _submit_cb(self):
        ...
        if check == 'yes':
            response = requests.put("http://localhost:5000/entitymanager/entities/" + str(acc_num),json=data)
